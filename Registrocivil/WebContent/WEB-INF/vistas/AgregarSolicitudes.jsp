					...
					<div class="card-content">
						<div class="field">
							...
							<div class="card-footer">
								<imput type="text" class="input" id="rutdelcliente-txt"
									name="rutdelcliente-txt" />
							</div>
						</div>
						<div class="card-content">
							<div class="field">
								...
								<div class="card-footer">
									<imput type="text" class="input" id="nombredelcliente-txt"
										name="nombredelcliente-txt" />
								</div>
							</div>
							<div class="field">
								<label class="label" for="tipodesolicitud-select">Tipo
									de Solicitud></label>
								<div class="control">
									<div class="select">
										<select name="tipodesolicitud-select"
											id=tipodesolicitud-select">
							...
							<tr>
								<td>${Solicitud.Solicitud de cedula de Identidad}</td>
								<td>${Solicitud.Retiro de cedula de Identidad}</td>
								<td>${Solicitud.Solicitud de certificado de Nacimiento}</td>
								<td>${Solicitud.Solicitud de Certificado de Defuncion}</td>
								<td>
									<a href="VerSolicitudesController.do?nombreEliminar=${consola.nombre}">
